...
> Este archivo pertenece al proyecto **Data Miner**. Cambios aquí solo afectan a este proyecto.
...
| Dato | Valor |
|---|---|
| Mod ID (`gradle.properties`) | `data_miner` |
| Clase principal | `DataMiner` |
| Display name (Title Case) | `Data Miner` |
...
|---|---|---|
| **snake_case** | `mod_id`, assets/, packages Java | `data_miner` |
| **PascalCase** | Clases Java principales | `DataMiner` |
| **camelCase** | Variables, métodos, config keys | `data_minerConfig` |
| **Title Case** | Display name (README, CHANGELOG, docs, CurseForge) | `Data Miner` |
