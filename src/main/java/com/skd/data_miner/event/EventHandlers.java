...
public class EventHandlers {
    ...
    public static void onPlayerInteract(PlayerInteractEvent.RightClickBlock event) {
        ...
        try {
            Player player = event.getEntity();
            BlockPos pos = event.getPos();
            ResourceLocation blockId = BuiltInRegistries.BLOCK.getKey(event.getLevel().getBlockState(pos).getBlock());
    ...
    public static void onEntityDamage(LivingDamageEvent.Pre event) {
        ...
        try {
            ...
            if (event.getSource().getEntity() != null) {
                ...
                ResourceLocation sourceId = BuiltInRegistries.ENTITY_TYPE.getKey(source.getType());
