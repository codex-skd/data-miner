...
1. **Trabaja con `docs/WORKFLOW_DATA_MINER_26-1-2.md`** — es el workflow operativo de este mod, autocontenido. Léelo y síguelo. No hay que actualizarlo por sesión.
...
3. Workflow del proyecto (`docs/WORKFLOW_DATA_MINER_26-1-2.md`).
