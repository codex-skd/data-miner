...
- **Release estable 1.0.1**. Promovido a estable tras prueba exitosa en instancia Fabric 26.2 (todos los archivos del startup generados correctamente).
- JAR: `data_miner-26.2-fabric-1.0.1.jar`.
...
- Rebuild del JAR para subida a CurseForge con nombre de archivo correcto (`data_miner-26.2-fabric-0.0.0-beta.2.jar`).
